...
def pair_compare(img, target_dark, gamma, alpha, beta):
    ...
    statistic, pvalue = ks_2samp(ydark, yreff)
...
def create_dark_images(imgs, alphas=(0.8, 0.9), betas=(1.5, 7), gammas=(1.5, 7), var_noises=(0.001, 0.01)):
    dark_imgs = []
    for img in imgs:
...
if __name__ == '__main__':
    ...
    for i, folder_name in enumerate(os.listdir(ds_folder)):
        ...
        dark_imgs = create_dark_images(imgs, alphas, betas, gammas, var_noises)
