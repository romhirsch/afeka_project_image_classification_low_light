...
def split_dataset_test_train(directory, target_path_test, target_path_train, percent=0.2):
    ...
    letter_counts = dict(Counter(list(df['Labels'].to_numpy())))
    num_test = 300
    #num_test = min(list(letter_counts.values()))
    ...
    for label in df['Labels'].unique():
        ...
        end_test = int(sub_df.shape[0]*percent) #num_test
...
if __name__ == '__main__':
    directory = r"E:\COCO_unified"
    target_path_test = r"E:\COCO_unified"
    target_path_train = r"E:\Exdark_split\low_train"
